...
public class BusActivity extends AppCompatActivity {
    ...
    public void spinner_setting1(){
        ...
        c = db.rawQuery("select * from bus where go_come = 'go' ORDER BY location ASC",null);
        while(c.moveToNext()){
        ...
        c = db.rawQuery("select * from bus where go_come = 'come' ORDER BY location ASC",null);
        while(c.moveToNext()){
        ...
        go_spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Cursor c = db.rawQuery("select * from bus where go_come = 'go' and location = '"+ string +"' ORDER BY time ASC",null);
        ...
        come_spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Cursor c = db.rawQuery("select * from bus where go_come = 'come' and location = '"+ string +"' ORDER BY time ASC",null);
